...
export const sysConfig={
	...
	uploadFileUrl:"http://socket.server.co:8088/",
	apiKey:"",
	avatarBase:"http://socket.server.co:8089/avatar/o/",
	xmppDomain:"im.server.co",
	// xmppHost:"120.79.25.45",
	// xmppUrl:"wss://test.shiku.co:5290",
	apiUrl : "http://socket.server.co:8092",// 接口地址
    xmppUrl:"wss://socket.server.co:5260",//xmpp 主机的 地址
}
// 系统变量
let myData={
	userId:null,
...
export default{
	...
	GetRequest:function() {
		...
		var url = window.location.search||window.location.hash//获取url中"?"符后的字串
 ...
 return ""
	...
	getOneMsg:function (userId,nickname,content="",type=1,isRoom=0,){
		let oneMsg = {"type":type,"content":content,"isEncrypt":0,"isRoom":isRoom,"jid":userId,"timeSend":this.getCurrentSeconds() };
